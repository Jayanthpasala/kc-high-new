  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-700 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Production Card */}
        <div className="bg-white rounded-[3rem] p-8 border-2 border-slate-100 shadow-sm hover:shadow-xl transition-all group flex flex-col justify-between h-full">
            <div>
        ...
        {/* Inventory Card */}
        <div className={`rounded-[3rem] p-8 border-2 shadow-sm hover:shadow-xl transition-all group flex flex-col justify-between h-full ${stats.lowStockCount > 0 ? 'bg-amber-50 border-amber-100' : 'bg-white border-slate-100'}`}>
            <div>
              <div className="flex justify-between items-start mb-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
        {[
            ...
            <button 
              ...
              className="bg-white p-6 rounded-[2.5rem] border-2 border-slate-100 shadow-sm hover:shadow-xl hover:border-slate-900 transition-all group text-left relative overflow-hidden"
            >
